      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative w-16 h-16 bg-white dark:bg-gray-800 rounded-lg p-2 shadow-md flex items-center justify-center">
              <img
                src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=https://example.com/cv"
                alt="CV QR Code"
